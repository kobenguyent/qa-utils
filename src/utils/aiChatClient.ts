 ...
 * 
 * Validation criteria that cause early failure:
 * - Missing API key for providers that require it (OpenAI, Anthropic, Google, Azure)
 * - Missing endpoint for providers that require it (Azure, Ollama)
